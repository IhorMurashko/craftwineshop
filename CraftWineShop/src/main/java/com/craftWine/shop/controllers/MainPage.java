...
public class MainPage {
    ...
    @Operation(
            ...
            description = "кожний обєкт репрезунтує вино, яке є на даний момент в магазині",

            responses = {@ApiResponse(
                    responseCode = "200", description = "статус ОК (200) та колекцію (массив) репрезентуючу вино"
            )}
